...
#
# html_title = u'MobileLibrary v0.0.1'
...
htmlhelp_basename = 'MobileLibrarydoc'
...
man_pages = [
    (master_doc, 'mobilelibrary', u'MobileLibrary Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MobileLibrary', u'MobileLibrary Documentation',
     author, 'MobileLibrary', 'One line description of project.',
     'Miscellaneous'),
]
...
MOCK_MODULES = ['cv2', 'numpy', 'win32ui', 'win32con', 'win32api', 'win32gui', 'win32process','robot.libraries.BuiltIn','BuiltIn','robot']
